...
public class Controller2D : RaycastController
{
        ...
        for(int i = 0; i<verticalRayCount; i++)
        {
            ...
            if(hit)
            {
                ...
                if(hit.collider.tag == "Through")
                {
                    ...
                    if(hit.collider == collisions.fallThroughPlatform) continue;
                    if(playerInput.y == -1)
                    {
                        /*  tutorial method
                        ...
                        */
                        ...
                        collisions.fallThroughPlatform = hit.collider; // youtube comment method
                        continue;
                    }
                }
                collisions.fallThroughPlatform = null; // youtube comment method for falling through platform
    ...
    /*  Only needed if using the tutorial method for falling through platform
    ...
    */
    ...
    public struct CollisionInfo
    {
        ...
        public int faceDir;
        // public bool fallingThroughPlatform; tutorial method to fall through platform
        public Collider2D fallThroughPlatform; // youtube comment method to fall through platform
